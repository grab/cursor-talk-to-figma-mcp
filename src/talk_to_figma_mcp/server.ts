...
server.tool(
  "get_reactions",
  "Get Figma Prototyping Reactions from multiple nodes for analyzing prototype flows and interactions.",
  {
  ...
  async ({ nodeIds }: any) => {
    try {
      ...
      return {
        ...
        // NOTE: Connector followUp disabled due to Figma API deprecation
        // followUp: {
        //   type: "prompt",
...
// NOTE: Connector strategy has been disabled due to Figma API deprecation
// Figma has officially blocked the FigJam Connector API
// See: https://github.com/grab/cursor-talk-to-figma-mcp/issues/106
...
type FigmaCommand =
  ...
  | "set_item_spacing"
  | "get_reactions"
  // NOTE: Connector commands disabled due to Figma API deprecation
  // | "set_default_connector"
  // | "create_connections"
  | "set_focus"
  | "set_selections";
...
type CommandParams = {
  ...
  // NOTE: Connector parameters disabled due to Figma API deprecation
  // set_default_connector: {
